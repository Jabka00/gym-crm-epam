...
MERGE INTO trainers (id, specialization_id) KEY (id) VALUES (1, 1);

MERGE INTO users (id, first_name, last_name, username, password, is_active) KEY (id)
    VALUES (2, 'Anna', 'Jones', 'Anna.Jones', 'xK9mPqWz1L', TRUE);
MERGE INTO trainers (id, specialization_id) KEY (id) VALUES (2, 2);

MERGE INTO users (id, first_name, last_name, username, password, is_active) KEY (id)
    VALUES (3, 'Mike', 'Brown', 'Mike.Brown', 'Tz7nVbCx4R', FALSE);
MERGE INTO trainers (id, specialization_id) KEY (id) VALUES (3, 3);

MERGE INTO users (id, first_name, last_name, username, password, is_active) KEY (id)
    VALUES (4, 'Alice', 'Walker', 'Alice.Walker', 'qW3eRt5yUi', TRUE);
MERGE INTO trainees (id, date_of_birth, address) KEY (id)
...
MERGE INTO trainee_trainer (trainee_id, trainer_id) KEY (trainee_id, trainer_id) VALUES (4, 1);
MERGE INTO trainee_trainer (trainee_id, trainer_id) KEY (trainee_id, trainer_id) VALUES (5, 2);
